...
- Documents that have different layouts, should go [into different collections](https://docs.microsoft.com/ai-builder/create-form-processing-model#group-documents-by-collections-preview) when you upload samples for training. 
