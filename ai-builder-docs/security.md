...
Scenarios such as object detection, text classification and binary classification require read access to entities from CDS. Make sure Environment Makers have access to them in case they need to use those entities as object to detect, tagged text and input data respectively.
