...
Learn how to get started in Copilot Studio with prepaid packs or the pay-as-you-go option in [Copilot Studio licensing](/microsoft-copilot-studio/billing-licensing).
The same documentation provides details about Copilot Credit allocation and consumption monitoring.

## AI Tools/AI Builder capabilities in Copilot Studio scenarios

In Copilot Studio, several scenarios involve AI Tools and AI Builder capabilities:
