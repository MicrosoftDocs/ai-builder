...
The [AI Builder calculator](https://powerapps.microsoft.com/ai-builder-calculator/ target="_blank") helps estimate the required add-on capacity based on your estimated consumption.
