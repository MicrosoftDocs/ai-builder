...
| Add text, image, or document input to a prompt | Preview\* | Preview\* | Preview\*   | Preview\*  |Preview\*   | Preview\*    | Preview\*    | Preview\*  | Preview\*   | Preview\*  | Preview\*  | Preview\*  | Preview\*   | Preview\*  | Preview\*  |              | Preview\*            |
...
- [Add text, image, or document input to a prompt](add-inputs-prompt.md) isn't available in GCC and GCC High
