...
| GPT-4o using image or document input | (Paid preview) | Paid preview | (Paid preview) | (Paid preview) | (Paid preview) | (Paid preview) | Paid preview | (Paid preview) | (Paid preview) | (Paid preview) | (Paid preview) | (Paid preview) | (Paid preview) | (Paid preview) | (Paid preview) | (Paid preview) | (Paid preview)       | -               | Paid preview   |
| o1                                   | (Paid preview) | -            | (Paid preview) | -              | -              | -              | -            | (Paid preview) | -              | (Paid preview) | (Paid preview) | (Paid preview) | (Paid preview) | (Paid preview) | -              | -        | (Paid preview)             | -               | Paid preview   |
