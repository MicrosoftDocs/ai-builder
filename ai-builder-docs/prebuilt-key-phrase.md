...
If you want to use this prebuilt model in Microsoft Power Automate, you can find more information in [Use key phrase extraction model in Microsoft Power Automate](flow-key-phrase-extraction.md).  
