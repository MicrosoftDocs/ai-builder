...
Using prompts in Power Apps or Power Automate consumes *AI Builder credits*, while using prompts in Microsoft Copilot Studio consumes *messages*. Learn more in [AI Builder licensing and credit management](credit-management).
